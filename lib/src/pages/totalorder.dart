                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(OrdersData.items[i].orderStatus.toString(),style: TextStyle(color: (OrdersData.items[i].orderStatus=="Delivered")?Theme.of(context).accentColor:Color(0xFF354B80),fontSize:14,fontWeight: FontWeight.w600),),
                                    SizedBox(width: 2,),
                                    Image.asset(
                                      OrdersData.items[i].img,
                                      // fit: BoxFit.fill,
                                     // color:(OrdersData.items[i].orderStatus=="Delivered")?Theme.of(context).accentColor:Color(0xFF354B80),
                                      width: 15.0,
                                      height: 15.0,
                                    ),
                                  ],
                          ...
                          trailing: Column(
                            ...
                            children: [
                              Text(OrdersData.items[i].orderStatus.toString(),style: TextStyle(color: Color(0xFF354B80),fontSize:14,fontWeight: FontWeight.w600),),
                              GestureDetector(
                                onTap: (){
                                  Navigator.of(context).pushNamed('/OrderDetails',
                                    arguments: RouteArgument(
