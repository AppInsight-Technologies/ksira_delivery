                        ...
                        child: Container(
                          ...
                          child: Column(
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Image.asset(
                                        ...
                                        // fit: BoxFit.fill,
                                       // color: (deliveredData.delivereditems[i].orderStatus=="Delivered")?Theme.of(context).accentColor:Color(0xFF354B80),
                                        width: 15.0,
                                        height: 15.0,
                                      ),
                                    ],
                            ...
                            trailing: Column(
                              ...
                              children: [
                                Text(deliveredData.delivereditems[i].orderstatus.toString(),style: TextStyle(color: Color(0xFF354B80),fontWeight: FontWeight.w600),),
                                GestureDetector(
                                  onTap: (){
                                    Navigator.of(context).pushNamed('/OrderDetails',
                                      arguments: RouteArgument(
                                  ...
                                  child: Container(
                                    ...
                                    width: 100,
                                    decoration: BoxDecoration(
                                        border:Border.all(color:(deliveredData.delivereditems[i].orderstatus=="completed")?Color(0xFF354B80):Theme.of(context).accentColor,)
                                    ),
                                    child: Center(child: Text('View Details',style: TextStyle(fontWeight: FontWeight.w500,color: (deliveredData.delivereditems[i].orderstatus=="completed")?Color(0xFF354B80):Theme.of(context).accentColor,),),),
                                  ),
                                ),
                              ],
                            ),
