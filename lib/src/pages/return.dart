                      ...
                      child: Container(
                        ...
                        child: Column(
                                ...
                                Row(
                                  children: [
                                    ...
                                    Image.asset(
                                      ...
                                      // fit: BoxFit.fill,
                                      //color: (returnData.returnitems[i].orderStatus=="Delivered")?Theme.of(context).accentColor:Color(0xFF354B80),
                                      width: 15.0,
                                      height: 15.0,
                                    ),
                                  ],
                          ...
                          trailing: Column(
                            ...
                            children: [
                              Text(returnData.returnitems[i].orderstatus.toString(),style: TextStyle(color: (returnData.returnitems[i].orderstatus=="completed")?Color(0xFF354B80):Theme.of(context).accentColor,fontWeight: FontWeight.w600),),
                              GestureDetector(
                                onTap: (){
                                ...
                                child: Container(
                                  ...
                                  width: 100,
                                  decoration: BoxDecoration(
                                      border:Border.all(color:(returnData.returnitems[i].orderstatus=="completed")?Color(0xFF354B80):Theme.of(context).accentColor,)
                                  ),
                                  child: Center(child: Text('View Details',style: TextStyle(fontWeight: FontWeight.w500,color: (returnData.returnitems[i].orderstatus=="completed")?Color(0xFF354B80):Theme.of(context).accentColor,),),),
                                ),
                              ),
                            ],
                          ),
