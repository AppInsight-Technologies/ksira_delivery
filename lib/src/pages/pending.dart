...
class PendingOrder extends StatefulWidget {
  ...
  PendingOrder({Key key, this.routeArgument}) : super(key: key);
  @override
        ...
        child: Container(
          ...
          child: Center(child: Text('Out for Delivery',style: TextStyle(fontSize:14,color: moodCheck== 1?Colors.white:Theme.of(context).accentColor),)),
               ...
               Center(
                 ...
                 shrinkWrap: true,
                 primary: false,
                 itemCount: PendingData.pendingitems.length,//OrdersWidget.ordersData.items.length,
                       ...
                       child: Column(
                         children: [
                           Row(
                             ...
                             children: [
                               Text('${S.of(context).order_id}:'+" "+'#${PendingData.pendingitems[i].orderid}',style: TextStyle(color: Theme.of(context).accentColor,fontWeight: FontWeight.w600,fontSize: 15)),
                               Row(
                                 children: [
                                   Text(PendingData.pendingitems[i].orderStatus.toString(),style: TextStyle(color: (PendingData.pendingitems[i].orderStatus=="Delivered")?Theme.of(context).accentColor:Color(0xFF354B80),fontSize:14,fontWeight: FontWeight.w600),),
                                   SizedBox(width: 2,),
                                   Image.asset(
                                     PendingData.pendingitems[i].img,
                                     // fit: BoxFit.fill,
                                     //color: (PendingData.pendingitems[i].orderStatus=="Delivered")?Theme.of(context).accentColor:Color(0xFF354B80),
                                     width: 15.0,
                                     height: 15.0,
                                   ),
                                 ],
                           ...
                           Row(
                             ...
                             children: [
                               Expanded(child:Container(
                                 child: Text(
                                   PendingData.pendingitems[i].address,
                               ...
                               Row(
                                 children: [
                                   Text(PendingData.pendingitems[i].orderType,style: TextStyle(color: Colors.black,fontSize:14,fontWeight: FontWeight.w500)),
                                   SizedBox(width: 2,),
                                   ( PendingData.pendingitems[i].orderType=="Standard Delivery")?Image.asset(Images.standard,height: 20,width: 20,):Image.asset(Images.express,height: 20,width: 20,),
                                 ],
                               )
                             ],
                           ),
                             ...
                             onTap: (){
                               Navigator.of(context).pushNamed('/OrderDetails',
                                 arguments: RouteArgument(
                                   id: PendingData.pendingitems[i].orderid,
                                   orderstatus: PendingData.pendingitems[i].orderstatus,
                                   payment_type: PendingData.pendingitems[i].payment_type,
                                   order_amount: PendingData.pendingitems[i].order_amount,
                                   fix_date: PendingData.pendingitems[i].fix_date,
                                   fix_time: PendingData.pendingitems[i].fix_time,
                                   customer_name: PendingData.pendingitems[i].customer_name,//OrdersWidget.ordersData.items[i].customer_name,
                                   address: PendingData.pendingitems[i].address,
                                   actual_amount: PendingData.pendingitems[i].actual_amount,
                                   delivery_charge:PendingData.pendingitems[i].delivery_charge,
                                   otp:PendingData.pendingitems[i].otp,
                                   index: i,
                                 ),
                               );
                             },
                         ...
                         trailing: Column(
                           ...
                           children: [
                             Text(PendingData.pendingitems[i].orderStatus.toString(),style: TextStyle(color: Color(0xFF354B80),fontSize:14,fontWeight: FontWeight.w600),),
                             GestureDetector(
                               onTap: (){
                                 Navigator.of(context).pushNamed('/OrderDetails',
                                   arguments: RouteArgument(
                               ...
                               child: Container(
                                 ...
                                 width: 100,
                                 decoration: BoxDecoration(
                                     border:Border.all(color:(PendingData.pendingitems[i].orderstatus=="completed")?Color(0xFF354B80):Theme.of(context).accentColor,)
                                 ),
                                 child: Center(child: Text('View Details',style: TextStyle(fontWeight: FontWeight.w500,color: (PendingData.pendingitems[i].orderstatus=="completed")?Color(0xFF354B80):Theme.of(context).accentColor,),),),
                               ),
                             ),
                           ],
                         ),
...
*//*
                         title: Padding(
                           ...
                           child: Text('${S.of(context).order_id}:'+" "+'#${PendingData.pendingitems[i].orderid}',style: TextStyle(color: Theme.of(context).accentColor,fontWeight: FontWeight.w600),),
                         ),
                         subtitle: Row(
                           children: [
