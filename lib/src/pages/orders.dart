                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child:Row(
                      ...
                      children: [
                        //SizedBox(width: 18,),
                        Text('Total Pending Orders',style: TextStyle(fontWeight: FontWeight.bold,color:Color(0xFF354B80),fontSize: 18),),
                        Row(
                          children: [
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(4),
                                  border: Border.all(color: Color(0xFF354B80),),
                                ),
                                child: Center(
                      ...
                      Container(
                        child: Row(
                          children: [
                            ...
                            IconButton(onPressed: (){}, icon: Icon(Icons.keyboard_arrow_right,size: 25,color:Color(0xFF354B80),))
                          ],
                        ),
                      )
                    ],
                          ...
                          return Theme(
                            ...
                            child: Container(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Text(DashBoradData.recentitems[i].orderStatus.toString(),style: TextStyle(color:( DashBoradData.recentitems[i].orderStatus=="Delivered")?Theme.of(context).accentColor:Color(0xFF354B80),fontSize:14,fontWeight: FontWeight.w600),),
                                          SizedBox(width: 2,),
                                          Image.asset(
                                            DashBoradData.recentitems[i].img,
                                           // fit: BoxFit.fill,
                                           // color: ( DashBoradData.recentitems[i].orderStatus=="Delivered")?Theme.of(context).accentColor:Color(0xFF354B80),
                                            width: 15.0,
                                            height: 15.0,
                                          ),
                                        ],
                              ...
                              trailing: Column(
                                ...
                                children: [
                                  Text(DashBoradData.recentitems[i].orderStatus.toString(),style: TextStyle(color: Color(0xFF354B80),fontSize:14,fontWeight: FontWeight.w600),),
                                  GestureDetector(
                                    onTap: (){
                                      Navigator.of(context).pushNamed('/OrderDetails',
                                        arguments: RouteArgument(
                  ...
                  Container(
                   ...
                   // radius: 16.0,
                    ...
                    child: /*Image.asset("assets/img/rupee.png",
                      ...
                      width: 50,
                      height: 30,),*/
                    Text(currency_format+ " "+wallet, style: TextStyle(fontSize: 16.0,fontWeight:FontWeight.bold,color: Color(0xFF354B80)),),
                  ),
                  SizedBox(
                    height: 5.0,
                  ),
